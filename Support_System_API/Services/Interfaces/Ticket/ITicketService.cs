...
using FeedBackResult = Support_System_API.Shared;
...
public interface ITicketService
{
    ...
    Task<FeedBackResult.OperationResult<TicketResponseDto>> UpdatedTicket(UpdateTicketDto request, Guid ticketId, Guid userId, String role);
